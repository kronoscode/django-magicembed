...
class ProvidersTest(unittest.TestCase):
    def testYoutube(self):
        ...
        thumbnail = '''<a href="http://google.com"><img src="http://img.youtube.com/vi/693m7iCh-TE/0.jpg" /></a>'''
    ...
    def testVimeo(self):
        ...
        thumbnail = '''<a href="#"><img src="http://b.vimeocdn.com/ts/137/933/137933005_200.jpg" /></a>'''
        self.assertEqual(vimeo.render_video(), embed)
        self.assertEqual(vimeo.render_thumbnail(), thumbnail)

    def testBliptv(self):
        blip = Blip('http://blip.tv/file/4985985/', (600, 400))
        ...
        thumbnail = '<a href="#"><img src="http://a.images.blip.tv/AnandaWorldwide-ResurrectionForEverySoul252-725.jpg" /></a>'
    ...
    def test_return_provider(self):
        ...
        self.assertTrue(isinstance(return_provider(yt), Youtube))
        self.assertTrue(isinstance(return_provider(vimeo), Vimeo))
        self.assertTrue(isinstance(return_provider(blip), Blip))
